...
export default function ExcluirCategoria({ obj }) {
    ...
    return (
        <>  
            <li  >{obj.nome}</li> 
            <MdDelete className="bg-red-600 text-3xl rounded-md text-white flex w-fit  mx-2 gap-10 p-1 items-center hover:cursor-pointer hover:bg-red-300 select-none" onClick={() => excluir(obj._id)} />
